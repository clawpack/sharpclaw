...
This code is no longer supported.  To use SharpClaw, please install Clawpack 5.0, following [these instructions](http://clawpack.github.io/doc/installing.html).
