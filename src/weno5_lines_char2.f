c
c ===================================================================
      subroutine weno5_lines_char2(ixy,maxm,meqn,mbc,mx,q_gauss,ql,qr,
     &                      auxl,auxr,evec)
c ===================================================================
...
c      are available
      ...
      parameter (mbcweno = 3,meqnweno=6,mxweno=10000)
      dimension qg(1-mbcweno:maxm+mbcweno,meqnweno)
      dimension du(1-mbcweno:maxm+mbcweno,meqnweno,ngauss)
      dimension uh(1-mbcweno:maxm+mbcweno,meqnweno,2,ngauss)
      dimension  u(1-mbcweno:maxm+mbcweno,meqnweno,2,ngauss)
      dimension hh(1-mbcweno:maxm+mbcweno,-2:2)
      dimension gau_evl(1-mbcweno:maxm+mbcweno,meqnweno,meqnweno,ngauss)
      dimension gau_evr(1-mbcweno:maxm+mbcweno,meqnweno,meqnweno,ngauss)
           ...
           do  i = 2-mbc,mx+mbc
              do m1 = -2,2
                 ...
                 do mm=1,meqn !DK Maybe meqn should be mwave?
                   hh(i,m1) = hh(i,m1)+
     &                       gau_evl(i,m,mm,ig)*du(i+m1,mm,ig)
                 enddo !meqn loop
              enddo !m1 loop
           enddo !i loop
