...
#------------------------------
    ...
    probdata.add_param('t1',   10.0,  'BC timescale')
    probdata.add_param('a1',   0.1,   'BC amplitude')
    probdata.add_param('tw1',   10.0,  'BC timescale')
    ...
    probdata.add_param('trtime',    600,   'time-reversal time')
